...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/601059a04e7e8b0015047e7d
...
To start editing your site, you can use the Sanity interface at https://hindise-consulting-059a0.sanity.studio/.
...
Generated at `2021-01-26T18:09:38.528Z` by Stackbit version `0.3.44`.